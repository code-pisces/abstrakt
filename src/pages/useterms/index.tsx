...
// code imports
import { Wrapper } from '@/styles/terms';

const useterms: React.FC = () => {
  return (
    <Wrapper>
      <Head>
        <title>Abstrakt | Política de Privacidade</title>
      </Head>
      <h2>Política Privacidade</h2>
      <p>
        A sua privacidade é importante para nós. É política do Abstrakt
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site
        <a href="https://www.abstrakt.social">Abstrakt</a>, e outros sites que
      ...
      <h2>Política de Cookies Abstrakt</h2> <h3>O que são cookies?</h3>
      <p>
      ...
      <p>
        ...
        informação que o Abstrakt oferece no site e com caráter enunciativo, mas
        não limitativo:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          xenofóbica, ou apostas desportivas (ex.:
        ...
        <li>
          ...
          (softwares) do Abstrakt, de seus fornecedores ou terceiros, para
