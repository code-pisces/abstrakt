...
exports.messages = exports.getAllowedLanguages = exports.getMessage = void 0;
/**
 ...
 */
const getMessage = (language, name) => {
    if (!name || name === "")
        return "";
...
const getAllowedLanguages = () => {
    return Object.keys(exports.messages);
};
exports.getAllowedLanguages = getAllowedLanguages;
/**
 * Return message list
 */
exports.messages = {
